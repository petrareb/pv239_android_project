...
class Recipe {
    constructor(
        name: String, source: String, isFavorite: Boolean, preparationTime: String,
    ...
    var preparationTime: String = ""// v minutach
    @ColumnInfo(name = "cooking_time")
    var cookingTime: String = "" // v minutach
    @ColumnInfo(name = "cooking_temp")
