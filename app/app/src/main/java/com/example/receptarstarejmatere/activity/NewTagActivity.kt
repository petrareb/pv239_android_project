...
import kotlinx.android.synthetic.main.activity_new_tag.*
...
class NewTagActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        newTagNameEditText = new_tag_name

        val saveButton = new_tag_save_button
        saveButton.setOnClickListener {
            if (!areValuesValid()) {
                ...
                Toast.makeText(
                    this,
                    resources.getString(R.string.success_new_tag),
                    Toast.LENGTH_SHORT
                ).show()
